    ...
    <tr>
      <td align="center">
        <details>
          ...
          <blockquote>
My primary interest within AI lies in proactively generating personal context data to enhance RAG pipelines for hyper-personalized inference. Currently, I am conducting a private experiment involving feeding contextual information about my life into a vector store, managed by an individual agent. I intend to share results once a substantial repository of context data has been developed and ingested. A working prototype of this workflow is available <a href="https://github.com/danielrosehill/Agentic-Context-Development-Interview-Demo">here</a>.
